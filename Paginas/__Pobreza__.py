...
def make_pobreza_web():
    ...
    with c1.container(border=True):
        ...
        c12.metric('Desempleo',f'{100*empleo['desempleo'][-1]:.2f}%',f'{100*(empleo['desempleo'][-1]-empleo['desempleo'][-2]):.2f} PP',delta_color='inverse')
        c13.metric('Pobreza',f'{100*S.pobind['Pobreza'][-1]:.2f}%',f'{100*(S.pobind['Pobreza'][-1]-S.pobind['Pobreza'][-2]):.2f} PP',delta_color='inverse')
        c14.metric('Indigencia',f'{100*S.pobind['Indigencia'][-1]:.2f}%',f'{100*(S.pobind['Indigencia'][-1]-S.pobind['Indigencia'][-2]):.2f} PP',delta_color='inverse')
    with c1.container(border=True):
