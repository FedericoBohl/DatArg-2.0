...
def plot_pobreza_indigencia(data):
    ...
    fig.add_trace(go.Scatter(x=data.loc['II Sem. 2007':'I Sem. 2016'].index,y=data.loc['II Sem. 2007':'I Sem. 2016']["Pobreza"]*100,name="Pobreza",line=dict(width=2.5,dash="dash"),marker_color="indigo",showlegend=False,legendgroup="Pobreza",mode="lines"))
    fig.add_trace(go.Scatter(x=data.loc['II Sem. 2007':'I Sem. 2016'].index,y=data.loc['II Sem. 2007':'I Sem. 2016']["Indigencia"]*100,name="Indigencia",line=dict(width=2.5,dash="dash"),showlegend=False,legendgroup="Indigencia",marker_color="#665A48",mode="lines"))
