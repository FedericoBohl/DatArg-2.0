...
def plot_emae(data:pd.DataFrame,var_m:pd.DataFrame,var_a:pd.DataFrame):
    ...
    fig_emae.add_trace(go.Bar(x=data.index,y=var_m['EMAE'],name='Var. Mensual',marker_color=var_m.apply(lambda x: 'green' if x >= 0 else 'red'),opacity=0.5,marker_line_color=black,marker_line_width=1),secondary_y=True)
    ...
    fig_campo.add_trace(go.Bar(x=data.index,y=var_m['Campo'],name='Var. Mensual',marker_color=var_m.apply(lambda x: 'green' if x >= 0 else 'red'),opacity=0.5,marker_line_color=black,marker_line_width=1),secondary_y=True)
    ...
    fig_minas.add_trace(go.Bar(x=data.index,y=var_m['Minas'],name='Var. Mensual',marker_color=var_m.apply(lambda x: 'green' if x >= 0 else 'red'),opacity=0.5,marker_line_color=black,marker_line_width=1),secondary_y=True)
    ...
    fig_comercio.add_trace(go.Bar(x=data.index,y=var_m['Comercio'],name='Var. Mensual',marker_color=var_m.apply(lambda x: 'green' if x >= 0 else 'red'),opacity=0.5,marker_line_color=black,marker_line_width=1),secondary_y=True)
    ...
    fig_inmob.add_trace(go.Bar(x=data.index,y=var_m['Inmobiliaria'],name='Var. Mensual',marker_color=var_m.apply(lambda x: 'green' if x >= 0 else 'red'),opacity=0.5,marker_line_color=black,marker_line_width=1),secondary_y=True)
