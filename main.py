...
def make_info():
    ...
    st.caption("DatArg es una aplicación sin fines de lucro que busca promover la transparencia de los datos económicos oficiales mediante un entorno que presente en *tiempo real* las principales variables de los distintos sectores económicos que involucran la coyuntura económica de un país, permitiendo su analisis y fácil comprensión, *todo en un solo lugar*. Su uso es tan extenso que preferimos que lo compruebes por vos mismo/a: analistas, consultores, profesores, periodistas y mucho más.")
